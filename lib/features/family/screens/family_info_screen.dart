...
//   /// التوكن يجي من شاشة الـ Login  الـ route arguments
//   /// Navigator.pushNamed(context, '/family', arguments: token)
...
//   bool get _isEditMode => widget.initialFamily != null; // << جديد
...
//   Navigator.of(context).pop(); // يسكّر الـ loading dialog
...
//   if (_isEditMode) {
//     Navigator.of(context).pop(); // رجوع لصفحة الهوم (لأنو دخلنا عن طريق push)
//   } else {
//     Navigator.pushReplacementNamed(context, '/home'); // أول مرة بعد اللوغ ان
//   }
// }
